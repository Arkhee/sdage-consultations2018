...
<div onclick="$('#rgpd').toggle();" style="margin-top:10px;text-decoration: underline; color:#3C679E; font-weight: bold;cursor:pointer;">Afficher les conditions générales et politique de confidentialité RGPD</div>
