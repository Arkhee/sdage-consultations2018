									...
									<div class="formulaire_avis {pressions.avis_valide}">
										...
										<div class='avis_ecriture'>
											...
											<form method="post" action="#" 
												...
												<label for="justification">Justification</label>
												<textarea onchange="frontCtl.checkLengthOnChange(this);" onkeyup="frontCtl.checkLengthOnChange(this);" onkeydown="frontCtl.checkLengthOnKeyPress(this);"  name="justification" style="width:100%; height:250px">{pressions.justification}</textarea><br />
