				<table class='listepressions'>
					...
					<tr>
						...
						<td align='center'><span class="icone_avis"><a title="{pressions.tooltip_avis_avis}" href='#avis_pression_{pressions.id_pression}_{pressions.id_massedeau}' class='fancybox'>
