...
<form id="formRecherche" name="formRecherche" method="post" action="{FORM_PAGE}">
	...
	<div id="rechercheavancee" style="display:flex;">
		<div class="blocfiltre manuel" data='ss_ut' data-lien="liste_ssbv"><label placeholder="Sélectionnez une sous-unité">Sous-unité territoriale :</label>{CMB_SS_UT}</div>
		<div class="blocfiltre manuel" data='ssbv' data-lien="liste_ss_ut"><label placeholder="Sélectionnez un sous-bassin">Sous-bassin versant :</label>{CMB_SSBV}</div>
