<?php
if(!isset($langtable["lexique_type"]))
	$langtable["lexique_type"]="Nom du type de cotisation";

class mdtb_lexique_types extends mdtb_table
{	
	function specific_init()
	{
		$this->table_name="#__lexique_types";
		$i=1;
		...
		$this->add_field("id_lexique_types","number","","","",0,0,0);
		$this->add_field("lexique_type","text","","","",$i,$i,$i++);
		$this->set_key("id_lexique_types");
		$this->searchable=array("lexique_type");
		$this->name="Types de Cotisation";
		$this->mode="self";
		
		$this->nbperpage=20;
		
		$this->_defaultparams->sortorder="ASC";
		$this->_defaultparams->sortfield="lexique_type";
