...
class sdage_metier
{
	...
	public function handle_Import()
	{
		...
		foreach($csv as $curData)
		{
			...
			file_put_contents(__DIR__."/import.log","Import pression ".$curData["code_pression"]." et mdo ".$arrMassesDeau[$curData["code_masse_eau"]]."... ");
			if($edl->recFirst())
			{
				file_put_contents(__DIR__."/import.log"," MISE A JOUR  ... ");
			...
			{
				file_put_contents(__DIR__."/import.log"," CREATION ... ");
				$edl->recNewRecord();
			...
			*/
			...
			file_put_contents(__DIR__."/import.log"," affectation valeurs ... ");
