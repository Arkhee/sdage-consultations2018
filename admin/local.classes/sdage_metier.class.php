...
class sdage_metier
{
	...
	const DATE_FIN_CONSULTATION="2018-10-31 11:37:00";
		...
		*/
		$requete="
			SELECT 
				...
				IF(a.pression_cause_du_risque IS NULL,'',a.pression_cause_du_risque) AS pression_cause_du_risque,
				IF(a.impact_estime IS NULL,'',a.impact_estime) AS impact_estime,
				...
				IF(a.date_validation LIKE '0000-00-00%','',CONCAT(IF(DAY(a.date_validation)<10,'0',''),DAY(a.date_validation),'/',IF(MONTH(a.date_validation)<10,'0',''),MONTH(a.date_validation),'/',YEAR(a.date_validation))) AS validation,
				a.commentaires,
				a.documents,
			...
			foreach($listeEdl as $edl)  //do
			{
				...
				(
					...
					(
						...
						'rnaoe_2027' => $edl->rnaoe_2027?"Oui":"Non",
					...
					foreach($listeEdl as $edl)  //do
					{
						...
						(
							...
							(
								...
								'rnaoe_2027' => $edl->recGetValue("rnaoe_2027")?"Oui":"Non",
