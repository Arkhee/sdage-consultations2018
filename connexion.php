...
<body class="<?php echo $auth->isLoaded()?("connecte connecte_".$auth->user_Rank):""; ?>">
	...
	<div id="content" class="container pageSetup">
		...
		<?php if(sdage_metier::isConsultationTerminee()) { 
			echo "<h3 style='text-align:center;font-weight:bold'>Consultation terminée<span style='display:none;'>".time()." vs ".strtotime(sdage_metier::DATE_FIN_CONSULTATION)."</span></h3>";
		} ?>
